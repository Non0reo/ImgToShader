...
(function(){
	...
	BlueNoise.prototype.diffuse = function(pixel, qPixel, strength, x, y)
	{
		var r_pix = (pixel & 0xff),
			g_pix = (pixel >>> 8) & 0xff,
			b_pix = (pixel >>> 16) & 0xff,
			a_pix = (pixel >>> 24) & 0xff;
		...
		return (a_pix << 24) | (b_pix << 16) | (g_pix <<  8) | r_pix;
	}
	...
	BlueNoise.prototype.dither = function()
	{
		...
		for (var y = 0; y < height; ++y) {
			for (var x = 0; x < width; ++x) {
				...
				c1 = this.diffuse(pixel, c1, strength, x, y);
				qPixels[bidx] = ditherFn(palette, c1, bidx);
			}
		}
